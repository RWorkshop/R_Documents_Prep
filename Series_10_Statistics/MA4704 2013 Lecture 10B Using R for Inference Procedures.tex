...
*  From the computer output, determine the $p-$value. \smallskip 
*  Compare the p-value to $\alpha/k$. \smallskip 
*  For all of the statistical computing procedures presented here, the tests are all two-tailed, with the exception of the Shapiro-Wilk Test. \smallskip 
*  If $p-$value $< 0.025$, then we reject $H_0$. \smallskip 
